        ...
        if (starts_with($size, 'image_')) {
            ...
            */
            throw new \InvalidArgumentException(
                "Invalid image size ($size). BlogEtcPost image size should not begin with 'image_'. Remove this from the start of $size. It *should* be in the blogetc.image_sizes config though!"
            );
        }

        throw new \InvalidArgumentException(
            "BlogEtcPost image size should be 'large','medium','thumbnail' or another field as defined in config/blogetc.php. Provided size ($size) is not valid"
        );
    }
